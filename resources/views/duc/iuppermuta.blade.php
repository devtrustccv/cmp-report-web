...
<table width="100%" cellspacing="0" cellpadding="0"
    ...
    <tr>
        <td style="padding:6px;">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" style="margin-top:8px; border:1px solid #000;">
                <tr>
                    <td width="50%" valign="top" style="padding:6px; border-right:1px solid #000;">
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="padding:3px 3px;"><strong>Permutante:</strong> <span style="text-decoration: underline;">{{$dados->permutante1 ?? '' }}</span></td>
                            </tr>
                            <tr>
                                <td style="padding:3px 3px;"><strong>Matriz:</strong> <span style="text-decoration: underline;">{{$dados->matriz1 ?? '' }}</span></td>
                            </tr>
                             <tr>
                                <td style="padding:3px 3px;"><strong>Valor Matriz:</strong> <span style="text-decoration: underline;">{{$dados->matriz2 ?? '' }}</span></td>
                            </tr>
                            <tr>
                                <td style="padding:3px 3px;"><strong>Área:</strong> <span style="text-decoration: underline;">{{$dados->superficie1 ?? '' }}</span>m2</td>
                            </tr>
                        </table>
                    </td>
                    <td width="50%" valign="top" style="padding:6px;">
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="padding:3px 3px;"><strong>Permutante:</strong> <span style="text-decoration: underline;">{{$dados->permutante2 ?? '' }}</span></td>
                            </tr>
                            <tr>
                                <td style="padding:3px 3px;"><strong>Matriz:</strong> <span style="text-decoration: underline;">{{$dados->matriz2 ?? '' }}</span></td>
                            </tr>
                            <tr>
                                <td style="padding:3px 3px;"><strong>Valor Matriz:</strong> <span style="text-decoration: underline;">{{$dados->matriz2 ?? '' }}</span></td>
                            </tr>
                            <tr>
                                <td style="padding:3px 3px;"><strong>Área:</strong> <span style="text-decoration: underline;">{{$dados->superficie2 ?? '' }}</span>m2</td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            @if(!empty($dados->torna))
                <table width="100%" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                    <tr>
                        ...
                        <td style="width:50%; padding:3px 3px;"><strong>A cargo de:</strong> <span style="text-decoration: underline;">{{ $dados->tornaBeneficiario ?? '' }}</span></td>
                    </tr>
                </table>
            @endif
        </td>
...
<table width="100%" cellspacing="0" cellpadding="0" style="page-break-inside: avoid; margin-bottom:80px;">
    <tr>
        <td width="50%" valign="top" style="padding-right:6px;">
            <h4>Descrição do Imóvel ({{$dados->matriz1 ?? ''}}-{{$dados->fraccao1 ?? ''}}):</h4>
            <p style="
        ...
        <td width="50%" valign="top" style="padding-left:6px;">
            <h4>Descrição do Imóvel ({{$dados->matriz2 ?? ''}}-{{$dados->fraccao2 ?? ''}}):</h4>
            <p style="
                border:1px solid #000;
                min-height:40px;
                padding:8px;
