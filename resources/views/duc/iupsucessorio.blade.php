...
<table width="100%" cellspacing="0" cellpadding="0"
    ...
    <tr>
        <td style="padding:6px;">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" style="margin-top:3px;">
                <tr>
                   <td style="width:64%; padding:3px 3px;"><strong>Total Pago:</strong> <span style="text-decoration: underline;">{{\App\Http\Utils::formatarComSeparador($dados->total_pago ?? 0) }}</span><span> {{ $dados->totalExtenso ?? ''}}</span> </td>
